...
export function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 border-t border-gray-200 dark:border-gray-600/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-12 md:py-16">
              ...
              {services.map((service, index) => (
                <li key={index}>
                  <button
                    ...
                    className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors text-left"
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-600/50">
