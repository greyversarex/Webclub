...
export function Footer() {
  ...
  return (
    <footer className="header-shimmer bg-gradient-to-r from-slate-800 via-slate-700 via-50% to-slate-800 border-t border-slate-600/50">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          <div className="col-span-2 md:col-span-1">
            ...
            >
              ...
              />
              <span className="font-display font-bold text-xl bg-gradient-to-r from-violet-400 via-violet-300 to-violet-500 bg-clip-text text-transparent">
                WEBCLUB
              </span>
            </button>
