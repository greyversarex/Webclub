...
type ResolvedProps = Required<Omit<MagicRingsProps, "blur" | "className">>;

const STATIC_FRAME_TIME = 1500;
...
export default function MagicRings({
  ...
  const propsRef = useRef<ResolvedProps | null>(null);
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      if (prefersReduced) renderFrame(STATIC_FRAME_TIME);
    };
    resize();
