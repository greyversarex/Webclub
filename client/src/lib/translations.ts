...
export const translations = {
  ru: {
    ...
    portfolio: {
      title: "Веб-сайты, мобильные приложения и корпоративные системы — от идеи до запуска",
      subtitle: "Примеры наших проектов для различных отраслей бизнеса",
      projects: [
    ...
    prototypes: {
      eyebrow: "Прототипы",
      title: "Готовые прототипы под ваш бизнес",
      subtitle: "Мы заранее собрали интерактивные демо-системы для разных сфер. Откройте любой прототип прямо в браузере или скачайте его — и увидите, как может выглядеть и работать ваш будущий продукт.",
      hint: "Это рабочие демонстрации с кликабельным интерфейсом, а не картинки.",
      live: "Живой прототип",
      open: "Открыть",
      download: "Скачать",
      items: [
        { category: "Магазин + CRM", title: "Commerce OS", description: "Интернет-магазин, CRM, склад, аналитика и автоматизация продаж в одной системе." },
        { category: "Логистика", title: "Logistics OS", description: "Управление грузами, фурами, складом и заявками через Telegram-бота." },
        { category: "Недвижимость", title: "Estate OS", description: "Продажа квартир и новостроек, ипотека и работа агентства недвижимости." },
        { category: "Отели", title: "Hotel OS", description: "Система управления отелем нового поколения: брони, номера, гости и сервис." },
        { category: "Медицина", title: "Clinic Care OS", description: "Система для клиник, лечебниц и медицинских центров: пациенты, записи и врачи." },
        { category: "Мебель", title: "Furniture OS", description: "AI-сайт, каталог, CRM, производство и дизайн мебели в единой платформе." },
        { category: "Приложения", title: "Mobile Apps OS", description: "Мобильные приложения под любые задачи бизнеса для iOS и Android." },
        { category: "Веб-сайты", title: "Website OS", description: "Сайты под любые задачи — от лендинга до корпоративного портала." },
        { category: "Аудит", title: "Audit OS", description: "Автоматический аудит документов, рисков, стандартов и соответствия законам." },
      ],
    },
    techStack: {
    ...
    testimonials: {
      ...
      reviews: [
        ...
        },
        {
          ...
          initials: "НР",
          company: "CEO, ModaShop",
          rating: 5,
          text: "Заказывали интернет-магазин с нуля. Команда всё время была на связи, объясняла каждый шаг. Сдали в срок, всё работает отлично. Продажи через сайт уже покрыли стоимость разработки.",
        },
        {
        ...
        },
        {
          ...
          initials: "ЗД",
          company: "Руководитель, EduPlatform",
          rating: 5,
          text: "Разрабатывали образовательную платформу с видеоуроками и тестами. Всё реализовали точно по ТЗ. Поддержка после запуска — оперативная, всегда отвечают. Очень довольна сотрудничеством.",
        },
        {
          name: "Бахром Юсупов",
          initials: "БЮ",
        ...
        },
        {
          ...
          initials: "КИ",
          company: "Маркетолог, RetailPro",
          rating: 4,
          text: "Делали лендинг для запуска нового продукта. Очень понравилось, что дали несколько вариантов дизайна на выбор. Конверсия страницы — 8.4%, что очень хорошо для нашей ниши.",
        },
      ],
    },
  },
  en: {
    ...
    prototypes: {
      eyebrow: "Prototypes",
      title: "Ready-made prototypes for your business",
      subtitle: "We've pre-built interactive demo systems for different industries. Open any prototype right in your browser or download it — and see how your future product could look and work.",
      hint: "These are working demos with clickable interfaces, not screenshots.",
      live: "Live prototype",
      open: "Open",
      download: "Download",
      items: [
        { category: "Store + CRM", title: "Commerce OS", description: "Online store, CRM, warehouse, analytics and sales automation in one system." },
        { category: "Logistics", title: "Logistics OS", description: "Manage cargo, trucks, warehouse and requests through a Telegram bot." },
        { category: "Real Estate", title: "Estate OS", description: "Sell apartments and new builds, handle mortgages and run a real-estate agency." },
        { category: "Hotels", title: "Hotel OS", description: "Next-generation hotel management: bookings, rooms, guests and service." },
        { category: "Healthcare", title: "Clinic Care OS", description: "A system for clinics, hospitals and medical centers: patients, appointments and doctors." },
        { category: "Furniture", title: "Furniture OS", description: "AI website, catalog, CRM, production and furniture design in one platform." },
        { category: "Apps", title: "Mobile Apps OS", description: "Mobile apps for any business task, for iOS and Android." },
        { category: "Websites", title: "Website OS", description: "Websites for any purpose — from a landing page to a corporate portal." },
        { category: "Audit", title: "Audit OS", description: "Automatic audit of documents, risks, standards and legal compliance." },
      ],
    },
    techStack: {
    ...
    testimonials: {
      ...
      reviews: [
        ...
        },
        {
          ...
          company: "CEO, ModaShop",
          rating: 5,
          text: "We ordered an online store from scratch. The team was always in touch, explained every step. Delivered on time, everything works great. Sales through the website already covered the development cost.",
        },
        {
          name: "Faridun Karimov",
          initials: "FK",
        ...
        },
        {
          ...
          initials: "ZD",
          company: "Head, EduPlatform",
          rating: 5,
          text: "We developed an educational platform with video lessons and tests. Everything was implemented exactly to spec. Post-launch support is prompt — they always respond. Very happy with the collaboration.",
        },
        {
          name: "Bakhrom Yusupov",
          initials: "BY",
        ...
        },
        {
          ...
          initials: "KI",
          company: "Marketing Manager, RetailPro",
          rating: 4,
          text: "They built a landing page for our new product launch. Really liked that they offered several design options. Page conversion rate is 8.4%, which is excellent for our niche.",
        },
      ],
    },
  },
  tj: {
    ...
    prototypes: {
      eyebrow: "Прототипҳо",
      title: "Прототипҳои тайёр барои бизнеси шумо",
      subtitle: "Мо пешакӣ системаҳои интерактивии намоишӣ барои соҳаҳои гуногун омода кардем. Ҳар прототипро бевосита дар браузер кушоед ё боргирӣ кунед — ва бубинед, ки маҳсулоти ояндаи шумо чӣ гуна намуд ва кор хоҳад кард.",
      hint: "Инҳо демоҳои корӣ бо интерфейси зершаванда мебошанд, на акс.",
      live: "Прототипи зинда",
      open: "Кушодан",
      download: "Боргирӣ",
      items: [
        { category: "Мағоза + CRM", title: "Commerce OS", description: "Мағозаи онлайн, CRM, анбор, таҳлил ва автоматикунонии фурӯш дар як система." },
        { category: "Логистика", title: "Logistics OS", description: "Идоракунии бор, мошинҳои боркаш, анбор ва дархостҳо тавассути Telegram-бот." },
        { category: "Амволи ғайриманқул", title: "Estate OS", description: "Фурӯши хонаву бинои нав, ипотека ва кори агентии амволи ғайриманқул." },
        { category: "Меҳмонхонаҳо", title: "Hotel OS", description: "Системаи идоракунии меҳмонхонаи насли нав: фармоишҳо, ҳуҷраҳо, меҳмонон ва хидмат." },
        { category: "Тиб", title: "Clinic Care OS", description: "Система барои клиникаҳо, беморхонаҳо ва марказҳои тиббӣ: беморон, қайдҳо ва духтурон." },
        { category: "Мебел", title: "Furniture OS", description: "Сомонаи AI, каталог, CRM, истеҳсолот ва тарҳрезии мебел дар як платформа." },
        { category: "Барномаҳо", title: "Mobile Apps OS", description: "Барномаҳои мобилӣ барои ҳар вазифаи бизнес барои iOS ва Android." },
        { category: "Вебсайтҳо", title: "Website OS", description: "Сомонаҳо барои ҳар мақсад — аз лендинг то портали корпоративӣ." },
        { category: "Аудит", title: "Audit OS", description: "Аудити худкори ҳуҷҷатҳо, хатарҳо, стандартҳо ва мутобиқат ба қонун." },
      ],
    },
    techStack: {
    ...
    testimonials: {
      ...
      reviews: [
        ...
        },
        {
          ...
          company: "CEO, ModaShop",
          rating: 5,
          text: "Мо мағозаи интернетиро аз сифр фармоиш додем. Тим ҳамеша дар тамос буд, ҳар қадамро шарҳ медод. Дар мӯҳлат супурданд, ҳама чиз олӣ кор мекунад.",
        },
        {
          name: "Фаридун Каримов",
          initials: "ФК",
        ...
        },
        {
          name: "Зарина Давлатова",
          initials: "ЗД",
          company: "Роҳбар, EduPlatform",
          rating: 5,
          text: "Платформаи таълимии бо видеодарсҳо ва тестҳо таҳия кардем. Ҳама чиз мувофиқи ТЗ иҷро шуд. Дастгирии баъди оғоз оперативист — ҳамеша ҷавоб медиҳанд.",
        },
        {
          name: "Баҳром Юсупов",
          initials: "БЮ",
        ...
        },
        {
          ...
          company: "Маркетолог, RetailPro",
          rating: 4,
          text: "Барои оғози маҳсулоти нав лендинг сохтанд. Хеле писандид, ки якчанд вариантҳои дизайн пешниҳод карданд. Конверсияи саҳифа 8.4% аст.",
        },
      ],
    },
  },
